...
class AccountUser(models.Model):
    ...
    profilepicture = models.CharField(db_column='profilePicture', max_length=100, blank=True, null=True)  # Field name made lowercase.
...
class TodoTodoappFields(models.Model):
    activity = models.TextField()
    createtime = models.TimeField(db_column='createTime')  # Field name made lowercase.
    ...
    userid = models.CharField(db_column='userID', max_length=99, blank=True, null=True)  # Field name made lowercase.
